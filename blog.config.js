...
const BLOG = {
  AUTHOR: 'wushuang', // 作者
  BIO: '一个普通的干饭人🍚', // 作者简介
  LINK: 'https://blog.jjhuang.cn/', // 网站地址
  KEYWORDS: 'Notion, 博客', // 网站关键词 英文逗号隔开
  NOTION_PAGE_ID:
  process.env.NOTION_PAGE_ID || '103c1bae65bf4ea393857645e2d7fb3c', // Important page_id！！！Duplicate Template from  https://www.notion.so/tanghh/02ab3b8678004aa69e9e415905ef32a5
  ...
  CONTACT_EMAIL: '524255440@qq.com', // 邮箱
  ...
  DESCRIPTION:
    process.env.NEXT_PUBLIC_DESCRIPTION || '记录、分享一些观点', // 站点描述，被notion中的页面描述覆盖
